...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mkdocs-autorefs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12100&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mkdocs-autorefs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mkdocs-autorefs` can be installed with:

```
conda install mkdocs-autorefs
```

It is possible to list all of the versions of `mkdocs-autorefs` available on your platform with:
